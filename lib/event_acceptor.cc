...
void eventstream_event_acceptor::schedule_event(pmt::pmt_t m){
    //printf("schedule_event.\n");
//    printf("eventstream_event_acceptor::schedule_event() called with .,.. \n");
//    pmt::print(m);
            ...
            if(pmt::is_pair(m) &&
                (pmt::is_null(pmt::car(m)) || pmt::is_dict(pmt::car(m))) ){
                    ...
                    if(pmt::is_uniform_vector(pmt::cdr(m))){    // often a source event
                        ...
                        printf("eventstream_event_acceptor received an almost-pdu! discarding!\n");
                        return;
                    }
                    ...
                    printf("eventstream_event_acceptor received non event! discarding!\n");
                }
            }
        }
...
void eventstream_event_acceptor::add_handlers(pmt::pmt_t h){
